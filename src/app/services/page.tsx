    ...
    <section className="bg-white border-y border-border py-16 md:py-20" id="carrosserie">
      <div className="wrap">
        ...
        <div className="bg-blue-light border border-blue/15 rounded-md p-4 text-[0.82rem] text-ink-2 leading-[1.6] mb-4">
          <strong className="text-ink">Note tarifaire :</strong> Les prestations carrosserie font systématiquement l&apos;objet d&apos;un devis — le prix dépend de la surface, de la teinte et de l&apos;étendue des dommages. Devis gratuit.
        </div>
  ...
  return (
    <section className="wrap py-16 md:py-20" id="panne">
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        ...
        {TEAM.map((m) => (
          <Button key={m.name} variant="whatsapp" as="a" href={waLink(m)} target="_blank">
